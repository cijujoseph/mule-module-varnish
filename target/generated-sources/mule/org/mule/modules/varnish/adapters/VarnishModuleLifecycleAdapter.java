...
/**
 * A <code>VarnishModuleLifecycleAdapter</code> is a wrapper around {@link VarnishModule } that adds lifecycle methods to the pojo.
 * 
 */
@Generated(value = "Mule DevKit Version 3.3.2", date = "2012-12-07T01:33:30-03:00", comments = "Build UNNAMED.1372.db235f3")
public class VarnishModuleLifecycleAdapter
    extends VarnishModuleMetadataAdapater
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(VarnishModuleLifecycleAdapter.class);
